...
object ClassificationSparkProcess {
    ...
    def classifyGraphs(order: Int, inputDir: String, outputDir: String, spark: SparkSession): Unit = {
        ...
        println("\n")
        println("*" * 70)
        println(s"Reading search space...")
        ...
        println(f"Found $count%,d highly irregular graphs of order $order")
